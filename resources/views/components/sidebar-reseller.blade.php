<aside class="fixed left-0 top-0 z-40 flex h-screen w-60 flex-col rounded-r-4xl border-r-4 border-pink-200 bg-white">
    ...
    <nav class="flex-1 overflow-y-auto py-2 [&::-webkit-scrollbar]:hidden">
        ...
        <a href="{{ route('reseller.pesanan.list') }}" class="group relative flex items-center gap-2 px-3.5 py-1.5 transition-colors hover:bg-pink-50">
            ...
            <span class="text-sm font-semibold text-pink-700">Pesanan Saya</span>
        </a>
        <a href="{{ route('reseller.pesanan.create') }}" class="group relative flex items-center gap-2 px-3.5 py-1.5 transition-colors hover:bg-pink-50">
            ...
            <span class="text-sm font-semibold text-pink-700">Buat Pesanan</span>
        </a>
        <a href="{{ route('reseller.payment.list') }}" class="group relative flex items-center gap-2 px-3.5 py-1.5 transition-colors hover:bg-pink-50">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-sm font-semibold text-pink-700">Pembayaran</span>
